...
Access to a running Verus Login Server or run your own -> https://github.com/tommyfpedersen/verus-login-server
...
Verus Mobile on your phone - find more information here: https://verus.io/wallet.

### 3.

A VerusId to test with - can be created in Verus Desktop App or Verus CLI - find more information here: https://verus.io/wallet.

## Setup

In config.js set the values to where the Verus Login Server is hosted.

VERUS_SERVER_API=http://192.168.1.121:8000
VERUS_SERVER_WS=ws://192.168.1.121:8000
