...
Access to a running Verus Login Server or run your own 
-> https://github.com/tommyfpedersen/verus-login-server
...
Verus Mobile on your phone 
- find more information here: https://verus.io/wallet.

### 3.

A VerusId to test with - can be created in Verus Desktop App or Verus CLI 
- find more information here: https://verus.io/wallet.
